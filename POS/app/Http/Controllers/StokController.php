    ...
    public function export_excel()
{
    ...
    foreach ($stok as $value) {
        ...
        $sheet->setCellValue('B' . $baris, $value->supplier->supplier_nama ?? $value->supplier_id);
        $sheet->setCellValue('C' . $baris, $value->barang->barang_nama ?? $value->barang_id);
        $sheet->setCellValue('D' . $baris, $value->user->nama ?? $value->user_id);
    ...
    $filename = 'Data_Stok_Barang_' . date('Ymd_His') . '.xlsx';
