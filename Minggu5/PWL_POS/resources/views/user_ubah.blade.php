...
<body>
    ...
    <a href="/PEMOGRAMAN-WEB-LANJUT-2025/Minggu4/PWL_POS/public/user">Kembali</a>
    <br><br>
    <form method="post" action="/PEMOGRAMAN-WEB-LANJUT-2025/Minggu4/PWL_POS/public/user/ubah_simpan/{{ $data->user_id }}">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
